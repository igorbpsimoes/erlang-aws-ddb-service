...
-compile({nowarn_unused_function,v_submsg_data/3}).
-dialyzer({nowarn_function,v_submsg_data/3}).
v_submsg_data(Msg, Path, TrUserData) -> v_msg_data(Msg, Path, TrUserData).
...
-compile({nowarn_unused_function,v_submsg_set_request/3}).
-dialyzer({nowarn_function,v_submsg_set_request/3}).
v_submsg_set_request(Msg, Path, TrUserData) -> v_msg_set_request(Msg, Path, TrUserData).
...
v_msg_set_request(#set_request{req = F1}, Path, TrUserData) ->
    v_submsg_data(F1, [req | Path], TrUserData),
    ok;
v_msg_set_request(X, Path, _TrUserData) -> mk_type_error({expected_msg, set_request}, X, Path).

-compile({nowarn_unused_function,v_submsg_set_response/3}).
-dialyzer({nowarn_function,v_submsg_set_response/3}).
v_submsg_set_response(Msg, Path, TrUserData) -> v_msg_set_response(Msg, Path, TrUserData).
...
-compile({nowarn_unused_function,v_submsg_get_request/3}).
-dialyzer({nowarn_function,v_submsg_get_request/3}).
v_submsg_get_request(Msg, Path, TrUserData) -> v_msg_get_request(Msg, Path, TrUserData).
...
-compile({nowarn_unused_function,v_submsg_get_response/3}).
-dialyzer({nowarn_function,v_submsg_get_response/3}).
v_submsg_get_response(Msg, Path, TrUserData) -> v_msg_get_response(Msg, Path, TrUserData).
...
v_msg_get_response(#get_response{error = F1, req = F2}, Path, TrUserData) ->
    ...
    if F2 == undefined -> ok;
       true -> v_submsg_data(F2, [req | Path], TrUserData)
    end,
    ok;
...
v_msg_req_envelope(#req_envelope{type = F1, set_req = F2, set_resp = F3, get_req = F4, get_resp = F5}, Path, TrUserData) ->
    ...
    if F2 == undefined -> ok;
       true -> v_submsg_set_request(F2, [set_req | Path], TrUserData)
    end,
    if F3 == undefined -> ok;
       true -> v_submsg_set_response(F3, [set_resp | Path], TrUserData)
    end,
    if F4 == undefined -> ok;
       true -> v_submsg_get_request(F4, [get_req | Path], TrUserData)
    end,
    if F5 == undefined -> ok;
       true -> v_submsg_get_response(F5, [get_resp | Path], TrUserData)
    end,
    ok;
...
fqbin_to_msg_name(<<"kv.proto.data">>) -> data;
fqbin_to_msg_name(<<"kv.proto.set_request">>) -> set_request;
fqbin_to_msg_name(<<"kv.proto.set_response">>) -> set_response;
fqbin_to_msg_name(<<"kv.proto.get_request">>) -> get_request;
fqbin_to_msg_name(<<"kv.proto.get_response">>) -> get_response;
fqbin_to_msg_name(<<"kv.proto.req_envelope">>) -> req_envelope;
fqbin_to_msg_name(E) -> error({gpb_error, {badmsg, E}}).


msg_name_to_fqbin(data) -> <<"kv.proto.data">>;
msg_name_to_fqbin(set_request) -> <<"kv.proto.set_request">>;
msg_name_to_fqbin(set_response) -> <<"kv.proto.set_response">>;
msg_name_to_fqbin(get_request) -> <<"kv.proto.get_request">>;
msg_name_to_fqbin(get_response) -> <<"kv.proto.get_response">>;
msg_name_to_fqbin(req_envelope) -> <<"kv.proto.req_envelope">>;
msg_name_to_fqbin(E) -> error({gpb_error, {badmsg, E}}).


fqbin_to_enum_name(<<"kv.proto.set_response.error_t">>) -> 'set_response.error_t';
fqbin_to_enum_name(<<"kv.proto.get_response.error_t">>) -> 'get_response.error_t';
fqbin_to_enum_name(<<"kv.proto.req_envelope.msg_type">>) -> 'req_envelope.msg_type';
fqbin_to_enum_name(E) -> error({gpb_error, {badenum, E}}).


enum_name_to_fqbin('set_response.error_t') -> <<"kv.proto.set_response.error_t">>;
enum_name_to_fqbin('get_response.error_t') -> <<"kv.proto.get_response.error_t">>;
enum_name_to_fqbin('req_envelope.msg_type') -> <<"kv.proto.req_envelope.msg_type">>;
...
get_all_source_basenames() -> ["service.proto"].
...
%% functions.
get_all_proto_names() -> ["service"].


get_msg_containment("service") -> [data, get_request, get_response, req_envelope, set_request, set_response];
get_msg_containment(P) -> error({gpb_error, {badproto, P}}).


get_pkg_containment("service") -> undefined;
get_pkg_containment(P) -> error({gpb_error, {badproto, P}}).


get_service_containment("service") -> [];
get_service_containment(P) -> error({gpb_error, {badproto, P}}).


get_rpc_containment("service") -> [];
get_rpc_containment(P) -> error({gpb_error, {badproto, P}}).


get_enum_containment("service") -> ['get_response.error_t', 'req_envelope.msg_type', 'set_response.error_t'];
get_enum_containment(P) -> error({gpb_error, {badproto, P}}).


get_proto_by_msg_name_as_fqbin(<<"kv.proto.data">>) -> "service";
get_proto_by_msg_name_as_fqbin(<<"kv.proto.set_request">>) -> "service";
get_proto_by_msg_name_as_fqbin(<<"kv.proto.get_request">>) -> "service";
get_proto_by_msg_name_as_fqbin(<<"kv.proto.set_response">>) -> "service";
get_proto_by_msg_name_as_fqbin(<<"kv.proto.req_envelope">>) -> "service";
get_proto_by_msg_name_as_fqbin(<<"kv.proto.get_response">>) -> "service";
...
get_proto_by_enum_name_as_fqbin(<<"kv.proto.set_response.error_t">>) -> "service";
get_proto_by_enum_name_as_fqbin(<<"kv.proto.get_response.error_t">>) -> "service";
get_proto_by_enum_name_as_fqbin(<<"kv.proto.req_envelope.msg_type">>) -> "service";
