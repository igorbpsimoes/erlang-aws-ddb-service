...
-define(service_pb_gpb_version, "4.21.3").
...
-record(set_request,
        {req                    :: service_pb:data() | undefined % = 1, required
        }).
-endif.
...
-record(get_response,
        {error                  :: ok | not_found | internal | integer() | undefined, % = 1, required, enum get_response.error_t
         req                    :: service_pb:data() | undefined % = 2, optional
        }).
-endif.
...
-record(req_envelope,
        {type                   :: set_request_t | set_response_t | get_request_t | get_response_t | integer() | undefined, % = 1, required, enum req_envelope.msg_type
         set_req                :: service_pb:set_request() | undefined, % = 2, optional
         set_resp               :: service_pb:set_response() | undefined, % = 3, optional
         get_req                :: service_pb:get_request() | undefined, % = 4, optional
         get_resp               :: service_pb:get_response() | undefined % = 5, optional
        }).
-endif.
